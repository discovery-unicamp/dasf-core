...
if device_target.lower() == "cpu":
    ...
    Stage0 += shell(commands=["pip install --no-dependencies --upgrade cupy_xarray"]) # this avoids CuPy being installed twice and taking too long (installation process doesn't find CuPy because its named cupy_cuda12x)
