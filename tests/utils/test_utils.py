...
from dasf.utils.utils import human_readable_size
from dasf.utils.utils import is_gpu_supported
from dasf.utils.utils import is_dask_local_supported
...
class TestArchitetures(unittest.TestCase):
    ...
    @patch('dasf.utils.utils.GPU_SUPPORTED', True)
    def test_is_gpu_supported_true(self):
        self.assertTrue(is_gpu_supported())

    @patch('dasf.utils.utils.GPU_SUPPORTED', False)
    ...
    @patch('dasf.utils.utils.is_dask_supported', return_value=False)
    ...
    @patch('dasf.utils.utils.is_dask_supported', return_value=True)
