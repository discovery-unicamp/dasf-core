...
class NNModule(LightningModule):
    def __init__(self, n_classes=4, learned_billinear=False, clip=0.1, class_weights=False):
        super().__init__()
...
class TorchPatchDeConvNet(ParameterOperator):
    def __init__(self, n_classes=4, learned_billinear=False, clip=0.1, class_weights=False):
        ...
        self.model = TorchPatchDeConvNetModule(n_classes, learned_billinear, clip, class_weights)

class TorchPatchDeConvNetSkip(ParameterOperator):
    def __init__(self, n_classes=4, learned_billinear=False, clip=0.1, class_weights=False):
        super().__init__(name=type(self).__name__)

        self.model = TorchPatchDeConvNetSkipModule(n_classes, learned_billinear, clip, class_weights)

class TorchSectionDeConvNet(ParameterOperator):
    def __init__(self, n_classes=4, learned_billinear=False, clip=0.1, class_weights=False):
        super().__init__(name=type(self).__name__)

        self.model = TorchSectionDeConvNetModule(n_classes, learned_billinear, clip, class_weights)

class TorchSectionDeConvNetSkip(ParameterOperator):
    def __init__(self, n_classes=4, learned_billinear=False, clip=0.1, class_weights=False):
        super().__init__(name=type(self).__name__)

        self.model = TorchSectionDeConvNetSkipModule(n_classes, learned_billinear, clip, class_weights)
