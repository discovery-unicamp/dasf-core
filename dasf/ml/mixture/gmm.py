...
class GaussianMixture(MixtureClassifier):
    def __init__(self, n_components=1, *, covariance_type='full', tol=0.001,
        ...
        self.__gmm_cpu = GaussianMixture_CPU(n_components=n_components,
...
class GaussianMixtureOp(ParameterOperator):
    def __init__(self, n_components=1, *, covariance_type='full', tol=0.001,
                 ...
                 weights_init=None, means_init=None, precisions_init=None,
                 random_state=None, warm_start=False, verbose=0,
                 verbose_interval=10, checkpoint=False):
        super().__init__(name="GaussianMixture")

        self._operator = GaussianMixture(n_components=n_components,
                                         covariance_type=covariance_type,
                                         tol=tol, reg_covar=reg_covar,
                                         max_iter=max_iter, n_init=n_init,
                                         init_params=init_params,
...
class GaussianMixtureFitPredictOp(FitPredictInternal):
    def __init__(self, checkpoint=False):
        super().__init__(name="GaussianMixtureFitPredict",
