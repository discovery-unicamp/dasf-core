...
class TrainTestSplit(Operator):
    ...
    def run_mgpu(self, X):
        raise NotImplementedError("Function train_test_split() is not "
                                  "implemented for Dask and CuML")
